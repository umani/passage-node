...
/**
 * Check if a given object implements the UpdateOtpAuthMethod interface.
 */
export function instanceOfUpdateOtpAuthMethod(_value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UpdateOtpAuthMethodFromJSON(json: any): UpdateOtpAuthMethod {
    return UpdateOtpAuthMethodFromJSONTyped(json, false);
}

export function UpdateOtpAuthMethodFromJSONTyped(json: any, _ignoreDiscriminator: boolean): UpdateOtpAuthMethod {
...
export function UpdateOtpAuthMethodToJSON(value?: UpdateOtpAuthMethod | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
